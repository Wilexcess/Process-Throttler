...
// --- Application Info ---
const std::wstring APP_VERSION = L"v1.3.5";
...
void create_gui_elements(HWND hwnd) {
	...
	g_hInboundCheck = CreateWindow(L"BUTTON", L"Inbound", WS_CHILD | BS_AUTOCHECKBOX, 10, y, 100, ITEM_HEIGHT, hwnd, (HMENU)201, NULL, NULL);
	g_hOutboundCheck = CreateWindow(L"BUTTON", L"Outbound", WS_CHILD | BS_AUTOCHECKBOX, 120, y, 100, ITEM_HEIGHT, hwnd, (HMENU)202, NULL, NULL);
	g_hBothCheck = CreateWindow(L"BUTTON", L"Both", WS_CHILD | BS_AUTOCHECKBOX, 230, y, 100, ITEM_HEIGHT, hwnd, (HMENU)203, NULL, NULL);
	g_hAlwaysOnTopCheck = CreateWindow(L"BUTTON", L"Always on Top", WS_CHILD | BS_AUTOCHECKBOX, 340, y, 120, ITEM_HEIGHT, hwnd, (HMENU)402, NULL, NULL);
...
void LoadSettings() {
	...
	CheckDlgButton(g_hwnd, 201, blockInbound ? BST_CHECKED : BST_UNCHECKED); CheckDlgButton(g_hwnd, 202, blockOutbound ? BST_CHECKED : BST_UNCHECKED);
	...
	bool enableTimed = GetPrivateProfileInt(L"Settings", L"EnableTimedMode", 1, g_iniPath) == 1; CheckDlgButton(g_hwnd, 401, enableTimed ? BST_CHECKED : BST_UNCHECKED); set_timed_mode_controls_state(enableTimed);
	bool alwaysOnTop = GetPrivateProfileInt(L"Settings", L"AlwaysOnTop", 1, g_iniPath) == 1; CheckDlgButton(g_hwnd, 402, alwaysOnTop ? BST_CHECKED : BST_UNCHECKED); if (alwaysOnTop) { SetWindowPos(g_hwnd, HWND_TOPMOST, 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE); }
